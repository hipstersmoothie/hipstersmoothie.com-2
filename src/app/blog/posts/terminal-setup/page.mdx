...
description: "A walkthrough of my terminal setup (Ghostty, oh-my-zsh, Powerlevel10k) plus the prompt customizations and aliases that make it feel amazing."
slug: terminal-setup
creationDate: 2021-05-30T01:45:13-07:00
tags: [tools]
atUri: "at://did:plc:m2sjv3wncvsasdapla35hzwj/site.standard.document/3mngd4ciq6v2g"
---
...
The hottest terminal on the block for OSX is [ghostty](https://ghostty.org/) its fast AND pretty.

### Ghostty settings

Here is my in progress config, first install [these fonts](https://github.com/romkatv/powerlevel10k?tab=readme-ov-file#meslo-nerd-font-patched-for-powerlevel10k)
